...
namespace
{
	...
	{
	public:
		solution() :agenda_(), nap_({ 0, { 10, 0 } }), counter_(0) {}
	...
	solution::operator bool()
	{
		...
		std::sort(agenda_.begin(), agenda_.end(), [](const appointment& app1, const appointment& app2) { return app1.start_ < app2.start_; });
